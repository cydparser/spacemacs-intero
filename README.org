...
*NOTE:* We now recommend using [[https://github.com/syl20bnr/spacemacs/tree/master/layers/%2Blang/haskell][Spacemacs haskell layer]], which now has support for intero, instead of this package.
